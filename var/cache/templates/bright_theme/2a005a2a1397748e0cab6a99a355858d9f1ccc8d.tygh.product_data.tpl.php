<?php /* Smarty version Smarty-3.1.21, created on 2021-10-24 13:23:09
         compiled from "C:\xampp\htdocs\cscart_v4.13.2.SP2_b2b\design\themes\responsive\templates\common\product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18921846056175340d47e949-41034054%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a005a2a1397748e0cab6a99a355858d9f1ccc8d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart_v4.13.2.SP2_b2b\\design\\themes\\responsive\\templates\\common\\product_data.tpl',
      1 => 1635066672,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '18921846056175340d47e949-41034054',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6175340dae9e29_81761491',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6175340dae9e29_81761491')) {function content_6175340dae9e29_81761491($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include 'C:/xampp/htdocs/cscart_v4.13.2.SP2_b2b/app/functions/smarty_plugins\\block.hook.php';
...
$_tmp17=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp17." ".((string)$_smarty_tpl->tpl_vars['product']->value['discount_prc'])."%", null, 0);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp18=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp18." ".((string)$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])."%", null, 0);?>
                <?php }?>
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("capture_product_labels_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['show_discount_label']->value&&($_smarty_tpl->tpl_vars['product']->value['discount_prc']||$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])&&$_smarty_tpl->tpl_vars['show_price_values']->value) {?>
                <?php if ($_smarty_tpl->tpl_vars['product']->value['discount']) {?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp19=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp19." ".((string)$_smarty_tpl->tpl_vars['product']->value['discount_prc'])."%", null, 0);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp20=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp20." ".((string)$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])."%", null, 0);?>
                <?php }?>
